  ...
  "(,)"
    :>: ( Forall
            ...
            ( []
                :=> ( TGen 0
                        `fn` TGen 1
                        `fn` foldl TAp tTuple2 (map TGen [0 .. 1])
                    )
            )
        )
    ...
    :>: ( Forall
            ...
            ( []
                :=> ( TGen 0
                        `fn` TGen 1
                        `fn` TGen 2
                        `fn` foldl TAp tTuple3 (map TGen [0 .. 2])
                    )
            )
        )
    ...
    :>: ( Forall
            ...
            ( []
                :=> ( TGen 0
                        ...
                        `fn` TGen 2
                        `fn` TGen 3
                        `fn` foldl TAp tTuple4 (map TGen [0 .. 3])
                    )
            )
        )
    ...
    :>: ( Forall
            ...
            ( []
                :=> ( TGen 0
                        ...
                        `fn` TGen 3
                        `fn` TGen 4
                        `fn` foldl TAp tTuple5 (map TGen [0 .. 4])
                    )
            )
        )
    ...
    :>: ( Forall
            ...
            ( []
                :=> ( ( (tIOError `fn` TAp tIOResult (TGen 0))
                          `fn` (TGen 0 `fn` TAp tIOResult (TGen 0))
                          `fn` TAp tIOResult (TGen 0)
                      )
                        `fn` TAp tIO (TGen 0)
                    )
            )
