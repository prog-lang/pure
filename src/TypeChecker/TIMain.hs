...
import TypeChecker.Assump (Assump (..), find)
import TypeChecker.Id (Id)
import TypeChecker.Infer (Infer)
import TypeChecker.Kind (Kind (Star))
import TypeChecker.Lit (Literal, tiLit)
import TypeChecker.Pat (Pat (PCon), tiPat, tiPats)
...
import TypeChecker.Scheme (Scheme (..), quantify, toScheme)
...
import TypeChecker.Subst (Subst, Types (apply, tv))
import TypeChecker.TIMonad (TI, freshInst, getSubst, newTVar, unify)
import TypeChecker.Type (Type (TGen, TVar), Tyvar, fn)
